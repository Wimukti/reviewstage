...
docker compose --profile demo up -d   # seeds sample runs so you can explore the UI
```
...
5. Writes and starts a systemd unit that binds the dashboard to `127.0.0.1:8899`.
