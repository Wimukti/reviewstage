...
<Shot name="hero" alt="The PR page for acme/widgets #38849: the agent’s assessment — “1 thing to fix before merge” with three bullets — above two staged finding cards, each with a ticked checkbox, a severity word, its file and line, and a one-line why-it-matters; the commit bar at the foot reads “2 staged” with a single Post selected to GitHub button." label="pr · 2 staged · COMMENT review" loading="eager" />
