...
<Shot name="integrations" alt="The Integrations page: GitHub connected as acme-dev, Slack and Discord connected with a member-ID field each, a generic webhook not yet configured with its signing header documented, and Claude connected." label="integrations · slack · discord · webhook" loading="eager" />
